...
(time (println "The answer is: " (sum-three-fives-multiples-below 1000)))
(time (println "The answer is: " (sum-three-fives-multiples-below2 1000)))
(time (println "The answer is: " (sum-three-fives-multiples-below3 1000)))
